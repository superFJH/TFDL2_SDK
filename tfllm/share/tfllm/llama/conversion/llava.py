...
class LlavaVisionModel(MmprojModel):
    ...
    def filter_tensors(cls, item):
        # TFLLM: Pixtral needs this one language row for [IMG_BREAK]. The
        # generic Mmproj filter otherwise drops it before modify_tensors.
        if item[0].endswith("embed_tokens.weight"):
