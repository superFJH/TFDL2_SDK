...
class Qwen2VLVisionModel(MmprojModel):
    def __init__(self, *args, **kwargs):
        ...
        if "embed_dim" in self.hparams_vision: # qwen2vl
            self.hparams_vision["intermediate_size"] = int(self.hparams_vision["embed_dim"] * self.hparams_vision.get("mlp_ratio", 4)) # TFLLM: vision FFN, not language/merger width
    ...
    def set_gguf_parameters(self):
        ...
        if model_type == 'qwen2_vl':
            ...
            self.gguf_writer.add_uint32("clip.vision.window_size", hparams.get("window_size", 112)) # TFLLM native window attention
        else:
