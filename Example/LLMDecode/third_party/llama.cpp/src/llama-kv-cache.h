...
public:
    ...
    // Import one complete external FP16 KV prefix.  See
    // llama_external_kv_f16 in the public C header for its layout contract.
    bool import_f16(llama_seq_id seq_id, const llama_external_kv_f16 & source);
