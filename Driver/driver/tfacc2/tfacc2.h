...
#include "tfacc_cache_uapi.h"
#include "tfacc_address_uapi.h"
#include "tfacc_model_pool_uapi.h"
...
enum tf_memory_backend {
    TF_MEMORY_RESERVED = 0,
    TF_MEMORY_HUGEPAGE = 1,
};
...
struct kbuf {
    ...
    struct tf_huge_region *huge_region;
    u64 pool_offset;
    u64 pool_previous_offset;
    int pool_index;
    bool is_model_pool;
};
